...
#import "CBHazeTransitionViewController.h"
#import "CBHazeTransitionRefreshView.h"
...
@interface CBHazeTransitionViewController () <UIScrollViewDelegate>
...
@property (nonatomic, strong) CBHazeTransitionRefreshView *upperRefreshView;
@property (nonatomic, strong) CBHazeTransitionRefreshView *lowerRefreshView;
...
@implementation CBHazeTransitionViewController
...
- (void)viewDidLoad
{
    ...
    self.upperRefreshView = [[CBHazeTransitionRefreshView alloc] initWithFrame:CGRectZero inScrollView:self.upperScrollView withDirection:RefreshViewDirectionDown];
    ...
    self.lowerRefreshView = [[CBHazeTransitionRefreshView alloc] initWithFrame:CGRectZero inScrollView:self.lowerScrollView withDirection:RefreshViewDirectionUp];
